...
<div class="bloc_outer">
    <div id="news_area">
    <h2><img src="<!--{$TPL_URLPATH}-->img/title/tit_bloc_news.gif" alt="新着情報" /><span class="rss"><a href="<!--{$smarty.const.ROOT_URLPATH}-->rss/<!--{$smarty.const.DIR_INDEX_PATH}-->" target="_blank"><img src="<!--{$TPL_URLPATH}-->img/button/btn_rss.jpg" alt="RSS" /></a></span></h2>
        <div class="bloc_body">
