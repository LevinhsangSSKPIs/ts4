...
<div id="under02column">
  <div id="title2">
  <span class="left"><img src="<!--{$TPL_DIR}-->img/cart/title.jpg" width="160" height="30" alt="現在のカゴの中" /></span>
  ...
  <p class="mini" style="color:#FF0000; padding:10px; margin-left: 20px; width: 700px;">※商品写真は参考用写真です。ご注文のカラーと異なる写真が表示されている場合でも、商品番号に記載されているカラー表示で間違いございませんのでご安心ください。</p>
  <div class="tblareabtn">
    <p>
      上記内容でよろしければ「購入手続きへ」ボタンをクリックしてください。<br /><br />
    </p>
   ...
   <!--{if $tpl_prev_url != ""}-->
     <p>
       <a href="<!--{$tpl_prev_url}-->" onmouseover="chgImg('<!--{$TPL_DIR}-->img/cart/b_pageback_on.gif','back');" onmouseout="chgImg('<!--{$TPL_DIR}-->img/cart/b_pageback.gif','back');">
         <img src="<!--{$TPL_DIR}-->img/cart/b_pageback.gif" width="110" height="20" alt="買い物を続ける" name="back" id="back" /></a>&nbsp;&nbsp;
   <!--{/if}-->
