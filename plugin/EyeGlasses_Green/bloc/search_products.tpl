...
<div id="searchblock">
<h2>
  <img src="<!--{$TPL_DIR}-->img/side/searchtitle.png" width="238" height="39" alt="検索条件" />
</h2>
<div id="searcharea" style="background: url("../img/side/search_bg.png") no-repeat;">
  <!--検索フォーム-->
    <form name="search_form" id="search_form" method="get" action="<!--{$smarty.const.URL_DIR}-->products/list.php">
      ...
      <p>商品名を入力</p>
      <p><input type="text" name="name" class="box142" maxlength="50" value="<!--{$smarty.get.name|escape}-->" /></p><br />
