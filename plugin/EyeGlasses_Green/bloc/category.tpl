...
<![endif]-->
<h2 class="cattitle">
  <img src="<!--{$TPL_DIR}-->/img/side/categorytitle.png" width="238" height="37" alt="商品カテゴリー" />
</h2>
<div id="categoryarea">
  <ul id="categorytree">
...
<!--商品カテゴリーここまで-->
<h3><img src="<!--{$TPL_DIR}-->/img/side/title_catbgbottom.png" width="238" height="10" alt="" /></h3>