...
<div id="mycontentsarea">
  ...
  <div id="mycontentsarea">
  <div id="bg">
  <h2 class="title"><img src="<!--{$TPL_DIR}-->img/mypage/subtitle05.jpg" width="140" height="30" alt="会員登録内容変更" /></h2><br />
    ...
    <table summary="お届け先" class="delivname">
      ...
      <tbody>
         <tr>
          ...
          <td class="td2"><!--{$arrDisp[$key1]|escape}-->&nbsp;<!--{$arrDisp[$key2]|escape}--></td>
        </tr>
        <tr>
          <th>お名前（フリガナ）</th>
        ...
        <tr>
          ...
          <td class="td2">〒<!--{$arrDisp[$key1]}-->-<!--{$arrDisp[$key2]}--></td>
        </tr>
        <tr>
          <th>住所</th>
          <!--{assign var=pref value=`$arrDisp.deliv_pref`}-->
          <!--{assign var=key value="deliv_addr01"}-->
          <td class="td2"><!--{$arrPref[$pref]}--><!--{$arrDisp[$key]|escape}--><!--{assign var=key value="deliv_addr02"}--><!--{$arrDisp[$key]|escape}--></td>
        </tr>
        <tr>
          <th>電話番号</th>
          ...
          <td class="td2"><!--{$arrDisp[$key1]}-->-<!--{$arrDisp[$key2]}-->-<!--{$arrDisp[$key3]}--></td>
        </tr>
      </tbody>
    </table>

    <div class="tblareabtn">
      <a href="./index.php" onmouseover="chgImg('<!--{$TPL_DIR}-->img/common/b_back_on.gif','change');" onmouseout="chgImg('<!--{$TPL_DIR}-->img/common/b_back.gif','change');"><img src="<!--{$TPL_DIR}-->img/common/b_back.gif" width="110" height="20" alt="戻る" name="change" id="change" /></a>
    </div>
    </div>
    </div>
    <div id="bgbottom2">
