 ...
 *}-->
  <!--[if IE 7]>
    ...
    div#productsubtitle span{
      margin-top: -17px;
    }
    div#productsubtitle span.subareatitle {
      margin-top: -10px;
    }
    </style>
<![endif]-->
...
<div id="bg">
<div id="title">
    　<span class="left"><img src="<!--{$TPL_DIR}-->img/common/left1.jpg" width="14" height="31" alt="" /></span>
      <span class="detailtitle"><!--★タイトル★--><!--{$tpl_subtitle}--></span>
      <span class="right"><img src="<!--{$TPL_DIR}-->img/common/right1.jpg" width="14" height="31" alt="" /></span> 
</div>
<!--▼CONTENTS-->
  <div id="producttitle"><!--★商品名★--><!--{$arrProduct.name|escape}--></div>
  <div id="statusicon">
      <!--アイコン-->
      ...
      <ul class="status_icon">
        ...
        <li>
          ...
          <img src="<!--{$TPL_DIR}--><!--{$arrSTATUS_IMAGE[$key]}-->" width="70" height="23" alt="<!--{$arrSTATUS[$key]}-->" id="icon<!--{$key}-->" />
        </li>
        <!--{/if}-->
        <!--{/section}-->
      </ul>
  ...
  <div id="detailarea">
    <div id="detailcomments"><!--★詳細メインコメント★--><!--{$arrProduct.main_comment|nl2br}--></div>
    ...
    <!--★画像★-->
      ...
      <!--★拡大する★-->
        <a href="javascript:void(win01('./detail_image.php?product_id=<!--{$arrProduct.product_id}-->&amp;image=main_large_image<!--{if $smarty.get.admin == 'on'}-->&amp;admin=on<!--{/if}-->','detail_image','<!--{$arrFile.main_large_image.width+60}-->', '<!--{$arrFile.main_large_image.height+80}-->'))" onmouseover="chgImg('<!--{$TPL_DIR}-->img/products/b_expansion_on.gif','expansion01');" onMouseOut="chgImg('<!--{$TPL_DIR}-->img/products/b_expansion.gif','expansion01');">
          <img src="<!--{$TPL_DIR}-->img/products/b_expansion.gif" width="91" height="21" alt="画像を拡大する" name="expansion01" id="expansion01" /></a>
      </p><br /><br />
      <!--{else}-->
      ...
      <div>
        ...
        <span class="price" style="color: #ffffff; font-weight:100;"><!--{$smarty.const.NORMAL_PRICE_TITLE}-->：
      ...
      <!--{if $smarty.const.USE_POINT === true}-->
        <div><span class="price" style="color: #ffffff;">ポイント：
          <!--{if $arrProduct.price02_min == $arrProduct.price02_max}-->
      ...
      <form name="form1" id="form1" method="post" action="<!--{$smarty.server.REQUEST_URI|escape}-->">
        ...
        <!--{if $tpl_stock_find}-->
            <p class="btn">
                <a href="javascript:void(document.form1.submit());" onmouseover="chgImg('<!--{$TPL_DIR}-->img/products/b_cartin_on.gif','cartin');" onmouseout="chgImg('<!--{$TPL_DIR}-->img/products/b_cartin.gif','cartin');"><img src="<!--{$TPL_DIR}-->img/products/b_cartin.gif" width="90" height="20" alt="カゴに入れる" name="cartin" id="cartin" /></a>
  ...
  <!--{assign var=key value="sub_title`$smarty.section.cnt.index+1`"}-->
    <!--{if $arrProduct[$key] != ""}-->
  <div class="subarea">
    <div id="productsubtitle">
    　<span class="left"><img src="<!--{$TPL_DIR}-->img/products/left.jpg" width="7" height="29" alt="" /></span>
      <span class="subareatitle"><!--★サブタイトル★--><!--{$arrProduct[$key]|escape}--></span>
      <span class="right"><img src="<!--{$TPL_DIR}-->img/products/right.jpg" width="9" height="29" alt="" /></span>    <br />
    </div>
  ...
  <div id="customervoicearea">
    <div id="productsubtitle">
    　<span class="left"><img src="<!--{$TPL_DIR}-->img/products/title_voice.jpg" width="215" height="29" alt="この商品に対するお客様の声" /></span>
      <span class="right"><img src="<!--{$TPL_DIR}-->img/products/right.jpg" width="9" height="29" alt="" /></span>    <br />
    </div>
    ...
    <!--{if count($arrReview) < $smarty.const.REVIEW_REGIST_MAX}-->
      ...
      <a href="./review.php"
        ...
        <img src="<!--{$TPL_DIR}-->img/products/b_comment.gif" width="148" height="20" alt="新規コメントを書き込む" name="review" id="review" /></a>
    <!--{/if}-->
    </div>
  </div>
  <!--お客様の声ここまで-->
  ...
  <!--{if $arrTrackbackView == "ON"}-->
    ...
    <div id="trackbackarea">
      <div id="productsubtitle">
    　  <span class="left"><img src="<!--{$TPL_DIR}-->img/products/title_tb.jpg" width="215" height="29" alt="この商品に対するトラックバック" /></span>
        <span class="right"><img src="<!--{$TPL_DIR}-->img/products/right.jpg" width="9" height="29" alt="" /></span>    <br />
      </div>
  ...
  <div id="whoboughtarea">
    <div id="productsubtitle">
    　<span class="left"><img src="<!--{$TPL_DIR}-->img/products/title_recommend.jpg" width="215" height="29" alt="その他のオススメ商品" /></span>
      <span class="right"><img src="<!--{$TPL_DIR}-->img/products/right.jpg" width="9" height="29" alt="" /></span>    <br />
    </div>
    <h2 class="recommend"></h2>
