...
<div id="under02column">
  ...
  <div id="bg">
    <p class="flowarea">
      <img src="<!--{$TPL_DIR}-->img/shopping/flow02.gif" width="518" height="27" alt="購入手続きの流れ" />
    </p>
    <div id="title2">
    <span class="left"><img src="<!--{$TPL_DIR}-->img/shopping/payment_title.jpg" width="205" height="30" alt="お支払い方法、お届け時間等の指定" /></span>
    <span class="right"><img src="<!--{$TPL_DIR}-->img/common/right3.jpg" width="12" height="30" alt="" /></span>    <br />
    </div>
    ...
    <form name="form1" id="form1" method="post" action="<!--{$smarty.server.PHP_SELF|escape}-->">
      ...
      <div class="payarea">
        <h2 class="subtitle"><img src="<!--{$TPL_DIR}-->img/shopping/subtitle01.jpg" width="140" height="30" alt="お支払方法の指定" /></h2>
        <br />
        <p>お支払方法をご選択ください。</p>
        ...
        <table summary="お支払方法選択">
          ...
          <tr>
            <td class="centertd"><input type="radio" id="pay_<!--{$smarty.section.cnt.iteration}-->" name="<!--{$key}-->" onclick="fnModeSubmit('payment', '', '');" value="<!--{$arrPayment[cnt].payment_id}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" <!--{$arrPayment[cnt].payment_id|sfGetChecked:$arrForm[$key].value}--></td>
            <td>
      ...
      <div class="payarea02">
        <h2 class="subtitle"><img src="<!--{$TPL_DIR}-->img/shopping/subtitle02.jpg" width="140" height="30" alt="お届け時間の指定" /></h2>
        <br />
      ...
      <div class="payarea02">
        <h2 class="subtitle"><img src="<!--{$TPL_DIR}-->img/shopping/subtitle03.jpg" width="140" height="30" alt="その他お問い合わせ" /></h2>
        <br />
      ...
      <!--{if $tpl_login == 1 && $smarty.const.USE_POINT === true}-->
        <div class="pointarea">
          <h2 class="subtitle"><img src="<!--{$TPL_DIR}-->img/shopping/subtitle_point.jpg" width="140" height="30" alt="ポイント使用の指定" /></h2>
          <br />
        ...
        <div>
          ...
          <ul>
            <li><input type="radio" id="point_on" name="point_check" value="1" <!--{$arrForm.point_check.value|sfGetChecked:1}--> onclick="fnCheckInputPoint();" />
              <label for="point_on">ポイントを使用する</label></li>
             ...
             <li><input type="radio" id="point_off" name="point_check" value="2" <!--{$arrForm.point_check.value|sfGetChecked:2}--> onclick="fnCheckInputPoint();" />
              <label for="point_off">ポイントを使用しない</label></li>
           </ul>
        </div>
      </div>
      <!--{/if}-->
      ...
      <div class="tblareabtn">
        <a href="<!--{$tpl_back_url|escape}-->" onmouseover="chgImg('<!--{$TPL_DIR}-->img/common/b_back_on.gif','back03')" onmouseout="chgImg('<!--{$TPL_DIR}-->img/common/b_back.gif','back03')">
          <img src="<!--{$TPL_DIR}-->img/common/b_back.gif" width="110" height="20" alt="戻る" border="0" name="back03" id="back03" /></a>&nbsp;
