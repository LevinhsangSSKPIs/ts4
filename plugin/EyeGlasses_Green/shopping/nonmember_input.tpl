...
<div id="under02column">
  <div id="under02column_customer">
    <div id="bg">
    <p class="flowarea"><img src="<!--{$TPL_DIR}-->img/shopping/flow01.gif" width="518" height="27" alt="購入手続きの流れ" /></p>
    <div id="title2">
    <span class="left"><img src="<!--{$TPL_DIR}-->img/shopping/info_title.jpg" width="160" height="30" alt="お客様情報入力" /></span>
      ...
      <table summary=" ">
        ...
        <tr>
          ...
          <td>
            ...
            <p class="zipimg"><a href="<!--{$smarty.const.URL_DIR}-->address/index.php" onclick="fnCallAddress('<!--{$smarty.const.URL_INPUT_ZIP}-->', 'order_zip01', 'order_zip02', 'order_pref', 'order_addr01'); return false;" target="_blank" onmouseover="chgImg('<!--{$TPL_DIR}-->img/common/address_on.gif','address');" onmouseout="chgImg('<!--{$TPL_DIR}-->img/common/address.gif','address');"><img src="<!--{$TPL_DIR}-->img/common/address.gif" width="110" height="20" alt="住所自動入力" name="address" id="address" /></a>
        ...
        <tr>
          ...
          <td>
           ...
           <!--{assign var=key2 value="deliv_zip02"}-->
            ...
            <p class="zipimg"><a href="<!--{$smarty.const.URL_DIR}-->address/index.php" onclick="fnCallAddress('<!--{$smarty.const.URL_INPUT_ZIP}-->', 'deliv_zip01', 'deliv_zip02', 'deliv_pref', 'deliv_addr01'); return false;" target="_blank" onmouseover="chgImg('<!--{$TPL_DIR}-->img/common/address_on.gif','address2');" onmouseout="chgImg('<!--{$TPL_DIR}-->img/common/address.gif','address2');"><img src="<!--{$TPL_DIR}-->img/common/address.gif" width="110" height="20" alt="住所自動入力" id="address2" name="address2"/></a>
              <span class="mini">&nbsp;郵便番号を入力後、クリックしてください。</span></p>
          </td>
        </tr>
        <tr>
