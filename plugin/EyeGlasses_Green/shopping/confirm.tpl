...
<div id="under02column">
  <div id="under02column_shopping">
    <div id="bg">
    <p class="flowarea"><img src="<!--{$TPL_DIR}-->img/shopping/flow03.gif" width="518" height="27" alt="購入手続きの流れ" /></p>
    <div id="title2">
    <span class="left"><img src="<!--{$TPL_DIR}-->img/shopping/confirm_title.jpg" width="160" height="30" alt="ご入力内容のご確認" /></span>
    ...
    <!--{* ログイン済みの会員のみ *}-->
      ...
      <div class="tblareabtn">
        <a href="./payment.php" onmouseover="chgImgImageSubmit('<!--{$TPL_DIR}-->img/common/b_back_on.gif',back03)" onmouseout="chgImgImageSubmit('<!--{$TPL_DIR}-->img/common/b_back.gif',back03)"><img src="<!--{$TPL_DIR}-->img/common/b_back.gif" width="110" height="20" alt="戻る" border="0" name="back03" id="back03" /></a>&nbsp;
        <!--{if $payment_type != ""}-->
