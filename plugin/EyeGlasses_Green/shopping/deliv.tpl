...
<div id="under02column">
  <div id="under02column_shopping">
    <div id="bg">
    <p class="flowarea">
      <img src="<!--{$TPL_DIR}-->img/shopping/flow01.gif" width="518" height="27" alt="購入手続きの流れ" />
    </p>
    <div id="title2">
    　<span class="left"><img src="<!--{$TPL_DIR}-->img/shopping/deliv_title.jpg" width="160" height="30" alt="MYページ" /></span>
    ...
    <p class="addbtn">&nbsp;&nbsp;
      <a href="<!--{$smarty.const.URL_DIR}-->mypage/delivery_addr.php" onclick="win02('<!--{$smarty.const.URL_DIR}-->mypage/delivery_addr.php?page=<!--{$smarty.server.PHP_SELF|escape}-->','new_deiv','600','640'); return false;" onmouseover="chgImg('<!--{$TPL_DIR}-->img/common/newadress_on.gif','addition');" onmouseout="chgImg('<!--{$TPL_DIR}-->img/common/newadress.gif','addition');"><img src="<!--{$TPL_DIR}-->img/common/newadress.gif" width="170" height="20" alt="新しいお届け先を追加する" name="addition" id="addition" /></a>
    </p>
    <!--{/if}-->
    <form name="form1" id="form1" method="post" action="<!--{$smarty.server.PHP_SELF|escape}-->">
      ...
      <div class="tblareabtn">
        <a href="<!--{$smarty.const.URL_DIR}-->cart/index.php" onmouseover="chgImgImageSubmit('<!--{$TPL_DIR}-->img/common/b_back_on.gif',back03)" onmouseout="chgImgImageSubmit('<!--{$TPL_DIR}-->img/common/b_back.gif',back03)">
          <img src="<!--{$TPL_DIR}-->img/common/b_back.gif" alt="戻る" border="0" name="back03" id="back03" width="110" height="20" /></a>
        <input type="image" onmouseover="chgImgImageSubmit('<!--{$TPL_DIR}-->img/shopping/b_select_on.gif',this)" onmouseout="chgImgImageSubmit('<!--{$TPL_DIR}-->img/shopping/b_select.gif',this)" src="<!--{$TPL_DIR}-->img/shopping/b_select.gif"  alt="選択したお届け先に送る" class="box190" name="send_button" id="send_button" width="151" height="21"/>
      </div>
    </form></div>
      <div id="bgbottom2">
