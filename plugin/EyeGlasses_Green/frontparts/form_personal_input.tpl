...
<tr>
  ...
  <td>
    ...
    <p class="zipimg"><a href="<!--{$smarty.const.URL_DIR}-->input_zip.php" onclick="fnCallAddress('<!--{$smarty.const.URL_INPUT_ZIP}-->', '<!--{$key1}-->', '<!--{$key2}-->', '<!--{$key3}-->', '<!--{$key4}-->'); return false;" target="_blank" onmouseover="chgImg('<!--{$TPL_DIR}-->img/common/address_on.gif','address');" onmouseout="chgImg('<!--{$TPL_DIR}-->img/common/address.gif','address');"><img src="<!--{$TPL_DIR}-->img/common/address.gif" width="110" height="20" alt="住所自動入力" id="address" name="address"/></a>
