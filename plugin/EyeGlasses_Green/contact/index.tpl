    ...
    <table summary="お問い合わせ">
      ...
      <tr>
        ...
        <td>
          ...
          <p class="zipimg">
            <a href="javascript:fnCallAddress('<!--{$smarty.const.URL_INPUT_ZIP}-->', 'zip01', 'zip02', 'pref', 'addr01');" onmouseover="chgImg('<!--{$TPL_DIR}-->img/common/address_on.gif','address');" onmouseout="chgImg('<!--{$TPL_DIR}-->img/common/address.gif','address');">
              <img src="<!--{$TPL_DIR}-->img/common/address.gif" width="110" height="20" alt="住所自動入力" name="address" id="address"/></a>
