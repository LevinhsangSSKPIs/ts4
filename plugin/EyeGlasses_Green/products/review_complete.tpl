...
<![endif]-->
  <div id="windowarea">
   <div id="title2">
    ...
    <div class="btn">
      <a href="javascript:window.close()" onmouseover="chgImg('<!--{$TPL_DIR}-->img/common/b_close_on.gif','b_close');" onmouseout="chgImg('<!--{$TPL_DIR}-->img/common/b_close.gif','b_close');"><img src="<!--{$TPL_DIR}-->img/common/b_close.gif" width="110" height="20" alt="閉じる" border="0" name="b_close" /></a>
    </div>
  </div>
</div>
