...
<!--{include file="`$smarty.const.TEMPLATE_DIR`popup_header.tpl" subtitle="住所検索" disable_wincol=1}-->
  ...
  <div id="zipsearchcolumn">
    <div id="title2">
    <span class="left"><img src="<!--{$TPL_DIR}-->img/common/zip_title.jpg" width="160" height="30" alt="住所検索" /></span>
    <span class="right"><img src="<!--{$TPL_DIR}-->img/common/right3.jpg" width="12" height="30" alt="" /></a></span>
    </div>
    ...
    <div class="btn"><a href="javascript:window.close()" onmouseover="chgImg('<!--{$TPL_DIR}-->img/common/b_close_on.gif','b_close');" onmouseout="chgImg('<!--{$TPL_DIR}-->img/common/b_close.gif','b_close');"><img src="<!--{$TPL_DIR}-->img/common/b_close.gif" width="110" height="20" alt="閉じる" border="0" name="b_close" /></a></div>
  </div>
